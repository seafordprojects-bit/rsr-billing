...
globalThis.__t={
  ...
  GROUP_FIELDS, firstDate, rankOf, sendLogFor, refreshSendMap, refreshReceiptMap, get receiptMap(){return receiptMap}, resendFlags, resendLabel, keepResend, historyLines, historyFor, dayOf,
  ...
  noCharge, billLabels, baseTitle, revNoOf, priorBillings, nextRevNo, amountOf, confirmMultiGroup, repaint, canonClient, maxIssuedNo, cmbHide, get sNoMode(){return sNoMode},
